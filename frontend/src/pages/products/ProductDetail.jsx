  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      const response = await axios.patch(
        ...
        }/dealer/products/updateProduct/${productId}`,
        formData,
        {
          headers: {
  ...
  const handleCommissionUpdate = async () => {
    ...
    try {
      const response = await axios.patch(
        `${
          import.meta.env.VITE_BACKEND_URL
        }/employee/products/commission/${productId}`,
        {
            ...
            <div className="flex gap-2">
              {isEditMode ? (
                ...
                <button
                  ...
                  className="px-4 py-2 bg-amber-700 text-white rounded-lg hover:bg-amber-800 flex items-center"
                >
                  <Save className="w-4 h-4 mr-2" />
                  Edit Product
                </button>
            ...
            <div className="bg-gray-50 rounded-lg p-4 space-y-3">
              <div>
                ...
                {isEditMode ? (
                  <input
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-xl font-bold"
                  />
                ) : (
              ...
              <div className="border-t pt-3">
                ...
                <div className="text-2xl font-bold text-green-600">
                  ₹
                  {(
                    parseFloat(formData.dealerPrice || product.dealerPrice) +
            ...
            <div className="border-t pt-6 space-y-2">
              ...
              {product.approvedAt && (
                <div className="flex items-center text-sm text-gray-600">
                  ...
                  Approved:{" "}
                  {new Date(product.approvedAt).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "long",
                    year: "numeric",
                    hour: "2-digit",
